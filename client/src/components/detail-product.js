        ...
        <div class="modal modal-blur fade" id="modal-simple" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <h5 class="modal-title">Informacion basica</h5>
                    ...
                    <div class="modal-body">
                        <h5 class="modal-title">Solicitantes y Responsables</h5>
                        <p><strong>Solicitante:</strong> <span id="modal-requester"></span></p>
                        <p><strong>Responsables:</strong> <span id="modal-responsibles"></span></p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn me-auto" data-bs-dismiss="modal">Cerrar</button>
                        <a id="modal-url-button" href="#" class="btn btn-primary" target="_blank">Ingresar al producto</a>
                    </div>
                </div>
            </div>
        </div>
