# Generated by Django 5.1 on 2024-08-24 03:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('Gestor de proyecto', 'Gestor de proyecto'), ('Analista de requerimientos', 'Analista de requerimientos'), ('Programador', 'Programador')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='versiones', to='productos.producto')),
            ],
            options={
